...
v1.0.1
*/
if(!class_exists('pisol_store_credit_review')){
class pisol_store_credit_review{
...
new pisol_store_credit_review('Store credit for WooCommerce plugin', 'store-credit-for-woocommerce');
}